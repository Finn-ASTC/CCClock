#ifndef CLK_KEY_IO2_H
#define CLK_KEY_IO2_H
...
/** Switch to NORMAL mode.  clk_normal_get_key_event2() becomes
 ...
 *  clk_key_io2_set_input().  All functions use character granularity.
 * ================================================================ */
...
/** Resume the background thread after clk_key_io2_test_pause(). */
